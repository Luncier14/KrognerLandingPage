            ...
            <div className='md:w-1/2 w-full' >
                ...
                <div>
                    <div className='flex items-center gap-2'>
                        ...
                        <span className='text-gray-600'>Developing grind</span>
                    </div>
                </div>
                <button className='mt-8 bg-indigo-500 text-white px-8 py-3 cursor-pointer rounded-full hover:bg-indigo-800 transition-colors'>Get started</button>
            </div>
